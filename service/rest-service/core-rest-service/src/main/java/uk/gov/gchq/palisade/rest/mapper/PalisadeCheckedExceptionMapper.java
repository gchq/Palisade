...
import uk.gov.gchq.palisade.exception.PalisadeCheckedException;
 ...
 * {@link uk.gov.gchq.palisade.exception.PalisadeCheckedException}s.
 */
@Provider
public class PalisadeCheckedExceptionMapper implements ExceptionMapper<PalisadeCheckedException> {
    @Override
    public Response toResponse(final PalisadeCheckedException gce) {
