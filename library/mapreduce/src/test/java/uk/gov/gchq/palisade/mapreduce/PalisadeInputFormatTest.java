...
public class PalisadeInputFormatTest {
    ...
    public void shouldAddDataRequest() {
        ...
        RegisterDataRequest rdr = new RegisterDataRequest().resourceId("testResource").userId(new UserId().id("user")).justification("justification");
    ...
    public void addAndGetRequests() {
        ...
        when(mockJob.getConfiguration()).thenReturn(c);
        RegisterDataRequest rdr = new RegisterDataRequest().resourceId("testResource").userId(new UserId().id("user")).justification("justification");
        RegisterDataRequest rdr2 = new RegisterDataRequest().resourceId("testResource2").userId(new UserId().id("user2")).justification("justification2");
    ...
    public static void setup() {
        request1 = new RegisterDataRequest().resourceId("res1").userId(new UserId().id("user1")).justification("just1");
        ...
        request2 = new RegisterDataRequest().resourceId("res2").userId(new UserId().id("user2")).justification("just2");
