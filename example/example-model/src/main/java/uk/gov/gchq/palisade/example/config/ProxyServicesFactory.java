...
import uk.gov.gchq.palisade.audit.service.impl.StroomSimpleAuditService;
...
//        return new LoggerAuditService();
        ...
        //in order to use the stroom service uncomment the following line:
        return new StroomSimpleAuditService();
    }
