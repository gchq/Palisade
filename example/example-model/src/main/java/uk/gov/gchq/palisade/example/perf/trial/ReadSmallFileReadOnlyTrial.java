 ...
 */
public class ReadSmallFileReadOnlyTrial extends PalisadeTrial {
    /**
     ...
     */
    public ReadSmallFileReadOnlyTrial(final int requests) {
        if (requests < 1) {
    ...
    @Override
    public String name() {
        return String.format("read_small_stream_%d", requests);
    }
