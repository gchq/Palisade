...
import uk.gov.gchq.palisade.example.client.EgeriaExampleSimpleClient;
...
public class EgeriaRestExample {
    private static final Logger LOGGER = LoggerFactory.getLogger(EgeriaRestExample.class);

    public static void main(final String[] args) throws Exception {
        if (args.length < 1) {
            System.out.printf("Usage: %s file\n", EgeriaRestExample.class.getTypeName());
