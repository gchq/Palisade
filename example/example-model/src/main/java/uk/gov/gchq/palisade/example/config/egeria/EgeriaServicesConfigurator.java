...
package uk.gov.gchq.palisade.example.config.egeria;
...
import uk.gov.gchq.palisade.example.config.ProxyServicesFactory;
 ...
 */
public class EgeriaServicesConfigurator {
    public static final String RESOURCE_TYPE = "employee";
    public static final String RESOURCE_FORMAT = "avro";
    protected static final Logger LOGGER = LoggerFactory.getLogger(EgeriaServicesConfigurator.class);
    private final ProxyServicesFactory clientServices;

    public EgeriaServicesConfigurator(final ProxyServicesFactory clientServices) {
    ...
    protected ResourceService createResourceServiceForServer() {
        try {
            EgeriaResourceService resource = new EgeriaResourceService("cocoMDS1", "http://localhost:18081");
            return resource;
