...
public class MapReduceExample extends Configured implements Tool {
     ...
     * @param purpose the example purpose
     */
    public static void addDataRequest(final JobContext context, final String filename, final String resourceType, final String userId, final String purpose) {
