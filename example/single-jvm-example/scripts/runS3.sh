...
java -cp example/single-jvm-example/single-jvm-example-runner/target/single-jvm-example-runner-*-shaded.jar uk.gov.gchq.palisade.example.SingleJvmExample "s3a://palisade-example-bucket/exampleObj_file1.txt"
