...
java -cp example/single-jvm-example/single-jvm-example-runner/target/single-jvm-example-runner-*-shaded.jar uk.gov.gchq.palisade.example.SingleJvmExample $1
