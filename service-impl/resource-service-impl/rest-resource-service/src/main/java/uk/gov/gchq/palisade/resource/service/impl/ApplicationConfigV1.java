...
public class ApplicationConfigV1 extends AbstractApplicationConfigV1 {
    ...
    public ApplicationConfigV1() {
        ...
        ResourceService delegate = RestResourceServiceV1.createService(System.getenv(ConfigConsts.CONFIG_SERVICE_PATH.get()));
        register(new ServiceBinder(delegate, ResourceService.class));
    }
}
