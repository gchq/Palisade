 ...
 * class to provide a specific style for Palisade.
 */
...
public class ToStringBuilder extends org.apache.commons.lang3.builder.ToStringBuilder {
    ...
    private static ToStringStyle getPalisadeToStringStyle() {
     ...
     */
    public static class PalisadeShortStyle extends PalisadeFullStyle {
        private static final long serialVersionUID = 7974675454897453336L;

        public PalisadeShortStyle() {
    ...
    /**
     * The default {@link ToStringStyle} to use in Palisade.
     */
    public static class PalisadeFullStyle extends ToStringStyle {
